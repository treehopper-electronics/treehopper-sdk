...
namespace TreehopperShowcase.ViewModels
{
    public class BlinkViewModel : Mvvm.ViewModelBase
    {
        ...
        public BlinkViewModel()
        {
            ...
            TreehopperUsb.ConnectionService.Boards.CollectionChanged += Boards_CollectionChanged;
            ...
            {
                foreach (var ledPanel in TreehopperUsb.ConnectionService.Boards)
                {
    ...
    public class LedBlinkerViewModel : Mvvm.ViewModelBase
    {
        ...
        public async void blinkingTask()
        {
            ...
            SevenSegSpi display = new SevenSegSpi(Board.SPI, 1);
            await display.Init();
