...
namespace Treehopper.Libraries.Interface.PortExpander
{
    ...
    public class Sn74hc595 : ShiftOut
    {
        ...
        /// </remarks>
        public Sn74hc595(Spi spiModule, SpiChipSelectPin latchPin, double speedMhz = 1) : base(spiModule, latchPin, 8, SpiMode.Mode00, ChipSelectMode.PulseHighAtEnd, speedMhz)
        {
        }
