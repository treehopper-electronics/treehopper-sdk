...
namespace Treehopper.Libraries.Interface.Adc
{
    ...
    public class Nau7802 : AdcPeripheralPin, IAdcPeripheral
    {
        ...
        private Ctrl1 ctrl1;
        private Ctrl2 ctrl2;
        private I2cCtrl i2cCtrl = new I2cCtrl();
        private Pga pga;
        ...
        private async Task<int> PerformConversion()
        {
            ...
            var result = (adcResult[0] << 24) | (adcResult[1] << 16) | (adcResult[2] << 8);
            result /= 256;
            return result;
        }
        ...
        {
            var ldoVoltage = 4.5 - (int) ctrl1.LdoVoltage * 0.3;
        ...
        {
            private readonly UInt24 Ocal1;
            private readonly uint GCal1;
            private readonly UInt24 Ocal2;
            private readonly uint GCal2;
        }
...
#pragma warning disable 649
        ...
        private struct Pga
        {
            [Bitfield(1)] public bool DisableChopper;
            [Bitfield(2)] private int Reserved;
            [Bitfield(1)] public bool InvertPgaInputPhase;
            [Bitfield(1)] public bool BypassPga;
            [Bitfield(1)] public bool OutputBufferEnable;
            [Bitfield(1)] public bool LdoImproveStability;
            [Bitfield(1)] public bool AdcReadWillReadOtp;
        }

        private struct Adc
        {
            [Bitfield(2)] public int EnableAdcClockDelay;
            [Bitfield(2)] public AdcCommonModeConfiguration commonMode;
            [Bitfield(2)] public AdcClockChopFrequency chopFrequency;
        }

        private struct PowerUpControl
        {
            [Bitfield(1)] public bool RegisterReset;

            [Bitfield(1)] public bool PowerUpDigitalCircuit;

            [Bitfield(1)] public bool PowerUpAnalogCircuit;

            [Bitfield(1)] public bool PowerUpReady;

            [Bitfield(1)] public bool CycleStart;

            [Bitfield(1)] public bool CycleReady;

            [Bitfield(1)] public bool UseExternalCrystal;

            [Bitfield(1)] public bool UseInternalLdo;
        }

        private struct Ctrl1
        {
            [Bitfield(3)] public GainSelect Gains;

            [Bitfield(3)] public LdoVoltage LdoVoltage;

            [Bitfield(1)] public bool DrdyOutputClockOrConversionReady;

            [Bitfield(1)] public bool ConversionReadyWhenCrdyLow;
        }

        private struct Ctrl2
        {
            [Bitfield(2)] public CalibrationMode CalMod;

            [Bitfield(1)] public bool CalStart;

            [Bitfield(1)] public bool CalError;

            [Bitfield(3)] public ConversionRate SampleRate;

            [Bitfield(1)] public Channel Channel;
        }

        private struct I2cCtrl
        {
            [Bitfield(1)] public bool DisableBandgapChopper;

            [Bitfield(1)] public bool ReadTemperatureSensor;

            [Bitfield(1)] public bool EnableBurnoutCurrentSource;

            [Bitfield(1)] public bool ShortInputTogether;

            [Bitfield(1)] public bool DisableWeakPullUp;

            [Bitfield(1)] public bool EnableStrongPullUp;

            [Bitfield(1)] public bool EnableFastReadAdcData;

            [Bitfield(1)] public bool EnablePullSdaLowOnConversionComplete;
        }
