...
namespace Treehopper.Libraries.Displays
{
    ...
    /// <remarks>
    ///     <para>
    ///         This driver provides support for many common 8-channel and 16-channel LED drivers that have an active-low
    ///         Output Enable (OE) pin that supports global brightness control through PWMing. The following ICs are examples
    ///         of drivers that are compatible with this library:
    ///         <list type="bullet">
    ///             <item>
    ///                 <term>Texas Instruments TLC591x</term><description>8-channel, up to 120 mA, 20V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Texas Instruments TLC5928</term><description>16-channel, up to 35 mA, 17V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Texas Instruments TLC5928x</term><description>16-channel, up to 45 mA, 10V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Silicon Touch (SiTI) ST2221A</term><description>8-channel, up to 90 mA, 9V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Silicon Touch (SiTI) ST2221C</term><description>16-channel, up to 90 mA, 9V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Macroblock MBI502x</term><description>16-channel, up to 90 mA, 17V</description>
    ///             </item>
    ///             <item>
    ///                 <term>Allegro A6282</term><description>16-channel, up to 50 mA, 12V</description>
    ///             </item>
    ///             <item>
    ///                 <term>ON Semiconductor CAT4016</term><description>16-channel, up to 100 mA, 5.5V</description>
    ///             </item>
    ///             <item>
    ///                 <term>ST STP16C596</term><description>16-channel, up to 120 mA, 16V</description>
    ///             </item>
    ///             <item>
    ///                 <term>ST STP16CP05</term><description>16-channel, up to 100 mA, 20V</description>
    ///             </item>
    ///             <item>
    ///                 <term>ST STP16CPC26</term><description>16-channel, up to 90 mA, 20V</description>
    ///             </item>
    ///             <item>
    ///                 <term>ISSI IS31FL3726</term><description>16-channel, up to 60 mA, 4V</description>
    ///             </item>
    ///             <item>
    ///                 <term>AMS AS1123</term><description>16-channel, up to 40 mA, 5.5V</description>
    ///             </item>
    ///         </list>
    ///         Note that any other 8-bit or 16-bit shift register can also be used with this library if you want an
    ///         <see cref="Led" />-based interface to the shift register. For example, the low-cost (and ubiquitous) 74HC595 is
    ///         perfectly capable of driving small indicator LEDs, and the TPIC6B595 could be used with this library to drive
    ///         high-voltage, high-power LEDs (or nixie tubes, etc).
    ///     </para>
    ///     <para>
    ...
    ///                 <term>Unmanaged</term>
    ///                 <description>
    ///                     The library doesn't do anything with the OE pin. You can tie it to GND in your circuit, or
    ///                     control it outside the context of this library by yourself.
    ///                 </description>
    ///             </item>
    ///             <item>
    ///                 <term>GPIO pin</term>
    ///                 <description>
    ///                     If you pass a GPIO pin to the constructor, the library will be able to globally
    ///                     enable/disable the display through the Brightness property. Setting a brightness of 0.5 or greater
    ///                     will turn on the display, otherwise, the display will be off.
    ///                 </description>
    ///             </item>
    ///             <item>
    ///                 <term>PWM pin</term>
    ///                 <description>
    ///                     If you pass a PWM pin to the constructor, the library will be able to control the global
    ///                     brightness of the display. Note that CIE perceptual brightness conversion will be performed, so,
    ///                     i.e., setting Brightness to 0.5 will produce a result that appears half as bright as a Brightness
    ///                     of 1.0.
    ///                 </description>
    ///             </item>
    ///         </list>
    ...
    public class LedShiftRegister : ChainableShiftRegisterOutput, ILedDriver
    {
        ...
        private readonly DigitalOut oe;
        private readonly Pwm oePwm;
        ...
        /// </summary>
        public IList<Led> Leds { get; } = new Collection<Led>();
