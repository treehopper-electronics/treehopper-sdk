    ...
    public partial class 
    {
        ...
        internal class Registers : RegisterManager
        {
            ...
            internal class AdcRegister : Register
            {
                ...
                public int RegChps { get; set; }
                public AdcVcms GetAdcVcm() { return (AdcVcms)AdcVcm; }
                public void SetAdcVcm(AdcVcms enumVal) { AdcVcm = (int)enumVal; }
                public RegChps GetRegChps() { return (RegChps)RegChps; }
                public void SetRegChps(RegChps enumVal) { RegChps = (int)enumVal; }
                ...
                internal override long GetValue() { return ((RegChp & 0x3) << 0) | ((AdcVcm & 0x3) << 2) | ((RegChps & 0x3) << 4); }
                internal override void SetValue(long value)
                {
