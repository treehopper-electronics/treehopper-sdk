...
namespace Treehopper.Libraries.Input
{
    ...
    /// <remarks>
    /// <para>
    /// This library implements an <see cref="IAccelerometer"/>-, <see cref="DigitalIn"/>-,  and <see cref="IPollable"/>-compatible input device that exposes the joystick, accelerometer, C button, and Z button on a Nintendo Wii (or compatible) Nunchuk controller. 
    /// </para>
    /// <para>
