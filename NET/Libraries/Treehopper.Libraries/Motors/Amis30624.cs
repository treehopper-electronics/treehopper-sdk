...
namespace Treehopper.Libraries.Motors
{
    ...
    public class Amis30624
    {
        ...
        /// <summary>
        ///     Determines whether a positive motion is clockwise or counter-clockwise. Note that this value is ignored for
        ///     RunVelocity mode!
        /// </summary>
        ...
        private void SetMotorParams()
        {
            ...
            data[4] = (byte) (((byte) (securePosition >> 8) << 5) | ((shaftDirection ? 1 : 0) << 4) |
                              ((byte) acceleration & 0x0f));
