...
@result A CF container is created and returned the caller on success. The caller should release with CFRelease. */
        ...
        public static extern IOKitError IOServiceAddInterestNotification(IntPtr notifyPort, IntPtr service,
            string interestType, IOServiceInterestCallback callback, int refCon, ref IntPtr notification);

        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IOKitError IOServiceAddMatchingNotification(IntPtr notifyPort, string notificationType,
            IntPtr matching, IOServiceMatchingCallback callback, IntPtr refCon, ref IntPtr notification);
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IntPtr IORegistryEntryCreateCFProperty(IntPtr entry, IntPtr key, IntPtr allocator,
            int options);
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IOKitError IOServiceGetMatchingServices(IntPtr masterPort, IntPtr matching,
            out IntPtr iterator);

        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IOKitError IOCreatePlugInInterfaceForService(IntPtr service, IntPtr pluginType,
            IntPtr interfaceType, out IntPtr plugIn, out int theScore);
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IntPtr IORegistryEntrySearchCFProperty(IntPtr entry, string plane, IntPtr key,
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern bool CFStringGetCString(IntPtr theString, char* buffer, long bufferSize,
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IOKitError IORegistryEntryCreateIterator(IntPtr entry, string plane, uint options,
            out IntPtr iterator);
        ...
        [DllImport(IOKitFrameworkPath, CharSet = CharSet.Ansi)]
        public static extern IntPtr CFUUIDGetConstantUUIDWithBytes(IntPtr alloc, byte byte0, byte byte1, byte byte2,
