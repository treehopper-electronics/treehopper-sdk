...
namespace Treehopper.Desktop.MacUsb.IOKit
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void IOServiceInterestCallback(int refCon, IntPtr service, uint messageType,
        IntPtr messageArgument);
    ...
    public static class IOKitFramework
    {
        ...
        public static int GetCFPropertyString(IOObject dictionary, string key, out string value)
        {
            ...
            var bsdPathAsCFValue = NativeMethods.IORegistryEntrySearchCFProperty(dictionary.Handle, kIOServicePlane,
                NativeMethods.__CFStringMakeConstantString(key), kCFAllocatorDefault, kIORegistryIterateRecursively);
            ...
            if (bsdPathAsCFValue != IntPtr.Zero)
                try
                {
                    unsafe
                    {
                        ...
                        {
                            var result = NativeMethods.CFStringGetCString(bsdPathAsCFValue, bsdValue, maxValueSize,
        ...
        public static int GetCFPropertyInt(IOObject dictionary, string key, out int value)
        {
            ...
            if (bsdPathAsCFValue != IntPtr.Zero)
                try
                {
                    ...
                    var result =
                        NativeMethods.CFNumberGetValue(bsdPathAsCFValue, CFNumberType.kCFNumberIntType, out bsdValue);
