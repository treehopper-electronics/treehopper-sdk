...
namespace WinApi.User32
{
    public static class User32Helpers
    {
            ...
            WindowExStyles dwExStyle)
        {
            ...
            if (res) Subtract(ref lpRect, ref rc);
            return res;
        }
        ...
        public static void Subtract(ref Rectangle lvalue, ref Rectangle rvalue)
        {
            ...
            var newLeft = lvalue.Left - rvalue.Left;
            var newTop = lvalue.Top - rvalue.Top;
            var newRight = lvalue.Right - rvalue.Right;
            var newBottom = lvalue.Bottom - rvalue.Bottom;
            lvalue = new Rectangle(newLeft, newTop, newRight + newLeft, newBottom + newTop);
        }
    }
}