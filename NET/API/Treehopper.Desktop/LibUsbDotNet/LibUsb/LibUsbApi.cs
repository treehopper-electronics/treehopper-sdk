...
namespace LibUsb
{
    ...
    public static class LibUsbApi
    {
        ...
        public static extern void SetDebug([In]LibUsbSessionHandle sessionHandle, int level);
        ...
        private static extern IntPtr OpenDeviceWithVidPidInternal([In]LibUsbSessionHandle sessionHandle, short vendorID, short productID);
        ...
        public static LibUsbDeviceHandle OpenDeviceWithVidPid([In]LibUsbSessionHandle sessionHandle, short vendorID, short productID)
        {
            IntPtr pHandle = OpenDeviceWithVidPidInternal(sessionHandle, vendorID, productID);
            if (pHandle == IntPtr.Zero) return null;
            return new LibUsbDeviceHandle(pHandle);
        }
        ...
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_get_configuration")]
        public static extern int GetConfiguration([In] LibUsbDeviceHandle deviceHandle, ref int configuration);
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the requested configuration does not exist</item>
        /// <item><see cref="LibUsbError.ErrorBusy"/> if interfaces are currently claimed</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_set_configuration")]
        public static extern int SetConfiguration([In] LibUsbDeviceHandle deviceHandle, int configuration);
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the requested interface does not exist</item>
        /// <item><see cref="LibUsbError.ErrorBusy"/> if another program or driver has claimed the interface </item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the interface was not claimed</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_release_interface")]
        public static extern int ReleaseInterface([In] LibUsbDeviceHandle deviceHandle, int interfaceNumber);
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the interface was not claimed, or the requested alternate setting does not exist</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the endpoint does not exist</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_clear_halt")]
        public static extern int ClearHalt([In] LibUsbDeviceHandle deviceHandle, byte endpoint);
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if re-enumeration is required, or if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failure</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_reset_device")]
        public static extern int ResetDevice([In] LibUsbDeviceHandle deviceHandle);
        ...
        public static extern int KernelDriverActive([In] LibUsbDeviceHandle deviceHandle, int interfaceNumber);
        ...
        /// <list type="bullet">
        /// <item>0 on success.</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if no kernel driver was active.</item>
        /// <item><see cref="LibUsbError.ErrorInvalidParam"/> if the interface does not exist.</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected </item>
        /// <item>Another <see cref="LibUsbError"/> code on other failure.</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_detach_kernel_driver")]
        public static extern int DetachKernelDriver([In] LibUsbDeviceHandle deviceHandle, int interfaceNumber);
        ...
        /// <item><see cref="LibUsbError.ErrorInvalidParam"/> if the interface does not exist.</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected.</item>
        /// <item><see cref="LibUsbError.ErrorBusy"/> if the driver cannot be attached because the interface is claimed by a program or driver.</item>
        /// <item>Another <see cref="LibUsbError"/> code on other failure.</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_attach_kernel_driver")]
        public static extern int AttachKernelDriver([In] LibUsbDeviceHandle deviceHandle, int interfaceNumber);
        ...
        /// <list type="bullet">
        /// <item>0 on success</item>
        /// <item><see cref="LibUsbError.ErrorNotFound"/> if the device is in unconfigured state </item>
        /// <item>another <see cref="LibUsbError"/> code on error</item>
        /// </list>
        /// </returns>
        ...
        /// <para>You only need to use this lock if you are developing an application which calls poll() or select() on libusb's file descriptors directly. If you stick to libusb's event handling loop functions (e.g. <see  cref="HandleEvents(LibUsbSessionHandle)">libusb_handle_events</see>) then you do not need to be concerned with this locking.</para>
        ...
        public static extern int TryLockEvents([In]LibUsbSessionHandle sessionHandle);
        ...
        public static extern void LockEvents([In]LibUsbSessionHandle sessionHandle);
        ...
        public static extern void UnlockEvents([In]LibUsbSessionHandle sessionHandle);
        ...
        public static extern int EventHandlingOk([In]LibUsbSessionHandle sessionHandle);
        ...
        public static extern int EventHandlerActive([In]LibUsbSessionHandle sessionHandle);

        /// <summary>
        /// Acquire the event waiters lock.
        /// </summary>
        /// <remarks>
        /// <para>This lock is designed to be obtained under the situation where you want to be aware when events are completed, but some other thread is event handling so calling <see  cref="HandleEvents(LibUsbSessionHandle)">libusb_handle_events</see> is not allowed.</para>
        ...
        /// <para>You only need to use this lock if you are developing an application which calls poll() or select() on libusb's file descriptors directly, and may potentially be handling events from 2 threads simultaenously. If you stick to libusb's event handling loop functions (e.g. <see  cref="HandleEvents(LibUsbSessionHandle)">libusb_handle_events</see>) then you do not need to be concerned with this locking.</para>
        /// <note type="tip" title="Libusb-1.0 API:"><seelibusb10 group="poll"/></note>
        /// </remarks>
        /// <param name="sessionHandle">A valid <see cref="LibUsbSessionHandle"/>.</param>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_lock_event_waiters")]
        public static extern void LockEventWaiters([In]LibUsbSessionHandle sessionHandle);
        ...
        public static extern void UnlockEventWaiters([In]LibUsbSessionHandle sessionHandle);
        ...
        /// <returns>0 on success, or a <see cref="LibUsbError"/> code on other failure.</returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_handle_events_timeout")]
        public static extern int HandleEventsTimeout([In]LibUsbSessionHandle sessionHandle, ref UnixNativeTimeval tv);
        ...
        public static extern int HandleEvents([In]LibUsbSessionHandle sessionHandle);
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_handle_events")]
        ...
        /// <para>This function is designed to be called under the situation where you have taken the event lock and are calling poll()/select() directly on libusb's file descriptors (as opposed to using <see  cref="HandleEvents(LibUsbSessionHandle)">libusb_handle_events</see> or similar). You detect events on libusb's descriptors, so you then call this function with a zero timeout value (while still holding the event lock).</para>
        /// <note type="tip" title="Libusb-1.0 API:"><seelibusb10 group="poll"/></note>
        /// </remarks>
        /// <param name="sessionHandle">A valid <see cref="LibUsbSessionHandle"/>.</param>
        /// <param name="tv">The maximum time to block waiting for events, or zero for non-blocking mode</param>
        ...
        public static extern int PollfdsHandleTimeouts([In]LibUsbSessionHandle sessionHandle);

        /// <summary>
        /// Determine the next internal timeout that libusb needs to handle. 
        /// </summary>
        /// <remarks>
        /// <para>You only need to use this function if you are calling poll() or select() or similar on libusb's file descriptors yourself - you do not need to use it if you are calling <see  cref="HandleEvents(LibUsbSessionHandle)">libusb_handle_events</see> or a variant directly.</para>
        ...
        /// <param name="sessionHandle">A valid <see cref="LibUsbSessionHandle"/>.</param>
        /// <param name="tv">The maximum time to block waiting for events, or zero for non-blocking mode</param>
        /// <returns>0 if there are no pending timeouts, 1 if a timeout was returned, or <see cref="LibUsbError.ErrorOther"/> on failure.</returns>
        ...
        public static extern void SetPollfdNotifiers([In]LibUsbSessionHandle sessionHandle,
        ...
        private static extern IntPtr GetPollfdsInternal([In]LibUsbSessionHandle sessionHandle);
        ...
        /// <item><see cref="LibUsbError.ErrorTimeout"/> if the transfer timed out</item>
        /// <item><see cref="LibUsbError.ErrorPipe"/> if the control request was not supported by the device.</item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failures</item>
        /// </list>
        /// </returns>
        [DllImport(LIBUSB_DLL, CallingConvention = CC, SetLastError = false, EntryPoint = "libusb_control_transfer")]
        public static extern int ControlTransfer([In] LibUsbDeviceHandle deviceHandle,
                                                         byte requestType,
                                                         byte request,
                                                         short value,
                                                         short index,
        ...
        /// <summary>
        /// Perform a USB control transfer for multi-threaded applications using the <see cref="LibUsbEventHandler"/> class.
        /// </summary>
        /// <remarks>
        /// <para>The direction of the transfer is inferred from the bmRequestType field of the setup packet.</para>
        /// <para>The wValue, wIndex and wLength fields values should be given in host-endian byte order.</para>
        ...
        /// </list>
        /// </returns>
        public static int ControlTransferAsync([In] LibUsbDeviceHandle deviceHandle,
                                                 byte requestType,
                                                 byte request,
                                                 short value,
                                                 short index,
                                                 ...
                                                 int timeout)
        {
            ...
            LibUsbSessionHandle sessionHandle = LibUsbEventHandler.SessionHandle;
            if (sessionHandle == null) 
                pSessionHandle = IntPtr.Zero;
            else
                pSessionHandle = sessionHandle.DangerousGetHandle();

            if (LibUsbEventHandler.IsStopped)
            {
                while (!completeEvent.WaitOne(0, false))
                {
                    ...
                    if (r < 0)
                    {
                        if (r == (int)LibUsbError.ErrorInterrupted)
                            continue;
                        transfer.Cancel();
                        while (!completeEvent.WaitOne(0, false))
        ...
        /// </list>
        /// </returns>
        public static int ControlTransfer([In] LibUsbDeviceHandle deviceHandle,
                                                  byte requestType,
                                                  byte request,
                                                  short value,
                                                  short index,
    ...
    /// <returns>on success, the number of bytes actually transferred, Other wise a <see cref="MonoUsbError"/>.</returns>
        ...
        public static extern int BulkTransfer([In] LibUsbDeviceHandle deviceHandle,
                                                      byte endpoint,
                                                      IntPtr pData,
                                                      int length,
        ...
        /// <item>0 on success (and populates <paramref name="actualLength"/>)</item>
        /// <item><see cref="LibUsbError.ErrorTimeout"/> if the transfer timed out</item>
        /// <item><see cref="LibUsbError.ErrorPipe"/> if the endpoint halted</item>
        /// <item><see cref="LibUsbError.ErrorOverflow"/>if the device offered more data, see <a href="http://libusb.sourceforge.net/api-1.0/packetoverflow.html">Packets and overflows</a></item>
        /// <item><see cref="LibUsbError.ErrorNoDevice"/> if the device has been disconnected</item>
        /// <item>another <see cref="LibUsbError"/> code on other failures</item>
        /// </list>
        /// </returns>
        public static int BulkTransfer([In] LibUsbDeviceHandle deviceHandle,
                                               byte endpoint,
                                               object data,
                                               int length,
                                               out int actualLength,
        ...
        public static extern int InterruptTransfer([In] LibUsbDeviceHandle deviceHandle,
                                                           byte endpoint,
                                                           IntPtr pData,
                                                           int length,
                                                           out int actualLength,
        ...
        /// </list>
        /// </returns>
        public static int InterruptTransfer([In] LibUsbDeviceHandle deviceHandle,
                                                    byte endpoint,
                                                    object data,
                                                    int length,
                                                    out int actualLength,
...
[StructLayout(LayoutKind.Sequential, Pack = 0)]
        ...
        /// <summary>
        /// Calls <see cref="LibUsbEventHandler.Init()"/> and <see cref="LibUsbEventHandler.Start"/> if <see cref="LibUsbEventHandler.IsStopped"/> = true.
        /// </summary>
        internal static void InitAndStart()
        {
            if (!LibUsbEventHandler.IsStopped) return;
            LibUsbEventHandler.Init();
            LibUsbEventHandler.Start();
        }

        /// <summary>
        /// Calls <see cref="LibUsbEventHandler.Stop"/> and <see cref="LibUsbEventHandler.Exit"/>.
        /// </summary>
        internal static void StopAndExit()
        {
#if LIBUSBDOTNET
            if (LibUsbDotNet.LibUsb.LibUsbDevice.mMonoUSBProfileList != null) LibUsbDotNet.LibUsb.LibUsbDevice.mMonoUSBProfileList.Close();
            LibUsbDotNet.LibUsb.LibUsbDevice.mMonoUSBProfileList = null;
#endif
            LibUsbEventHandler.Stop(true);
            LibUsbEventHandler.Exit();
        }
