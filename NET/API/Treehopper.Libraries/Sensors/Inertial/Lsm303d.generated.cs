    ...
    public partial class Lsm303d
    {
        ...
        protected class Lsm303dRegisters : RegisterManager
        {
            ...
            internal class IntCtrlRegister : Register
            {
                ...
                public async Task<IntCtrlRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class IntSourceRegister : Register
            {
                ...
                public async Task<IntSourceRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class IntThresholdRegister : Register
            {
                ...
                public async Task<IntThresholdRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class OffsetXRegister : Register
            {
                ...
                public async Task<OffsetXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class OffsetYRegister : Register
            {
                ...
                public async Task<OffsetYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class OffsetZRegister : Register
            {
                ...
                public async Task<OffsetZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class ReferenceXRegister : Register
            {
                ...
                public async Task<ReferenceXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class ReferenceYRegister : Register
            {
                ...
                public async Task<ReferenceYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class ReferenceZRegister : Register
            {
                ...
                public async Task<ReferenceZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class Ctrl7Register : Register
            {
                ...
                public async Task<Ctrl7Register> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class StatusARegister : Register
            {
                ...
                public async Task<StatusARegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
