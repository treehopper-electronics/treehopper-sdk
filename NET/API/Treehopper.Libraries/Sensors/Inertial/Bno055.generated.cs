    ...
    public partial class Bno055
    {
        ...
        protected class Bno055Registers : RegisterManager
        {
            ...
            internal class ChipIdRegister : Register
            {
                ...
                public async Task<ChipIdRegister> read()
                {
            ...
            internal class AccelChipIdRegister : Register
            {
                ...
                public async Task<AccelChipIdRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagChipIdRegister : Register
            {
                ...
                public async Task<MagChipIdRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GyroChipIdRegister : Register
            {
                ...
                public async Task<GyroChipIdRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SwRevisionRegister : Register
            {
                ...
                public async Task<SwRevisionRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class BootloaderVersionRegister : Register
            {
                ...
                public async Task<BootloaderVersionRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class PageIdRegister : Register
            {
                ...
                public async Task<PageIdRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelXRegister : Register
            {
                ...
                public async Task<AccelXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelYRegister : Register
            {
                ...
                public async Task<AccelYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelZRegister : Register
            {
                ...
                public async Task<AccelZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerXRegister : Register
            {
                ...
                public async Task<MagnetometerXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerYRegister : Register
            {
                ...
                public async Task<MagnetometerYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerZRegister : Register
            {
                ...
                public async Task<MagnetometerZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class EulHeadingRegister : Register
            {
                ...
                public async Task<EulHeadingRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class EulRollRegister : Register
            {
                ...
                public async Task<EulRollRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class EulPitchRegister : Register
            {
                ...
                public async Task<EulPitchRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class QuaWRegister : Register
            {
                ...
                public async Task<QuaWRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class QuaXRegister : Register
            {
                ...
                public async Task<QuaXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class QuaYRegister : Register
            {
                ...
                public async Task<QuaYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class QuaZRegister : Register
            {
                ...
                public async Task<QuaZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class LinXRegister : Register
            {
                ...
                public async Task<LinXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class LinYRegister : Register
            {
                ...
                public async Task<LinYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class LinZRegister : Register
            {
                ...
                public async Task<LinZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GravXRegister : Register
            {
                ...
                public async Task<GravXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GravYRegister : Register
            {
                ...
                public async Task<GravYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GravZRegister : Register
            {
                ...
                public async Task<GravZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class CalibStatRegister : Register
            {
                ...
                public async Task<CalibStatRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SelfTestResultRegister : Register
            {
                ...
                public async Task<SelfTestResultRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SysClockStatusRegister : Register
            {
                ...
                public async Task<SysClockStatusRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SysStatusRegister : Register
            {
                ...
                public async Task<SysStatusRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SysErrRegister : Register
            {
                ...
                public async Task<SysErrRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class UnitSelRegister : Register
            {
                ...
                public async Task<UnitSelRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class OperatingModeRegister : Register
            {
                ...
                public async Task<OperatingModeRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class PowerModeRegister : Register
            {
                ...
                public async Task<PowerModeRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class SysTriggerRegister : Register
            {
                ...
                public async Task<SysTriggerRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class TempSourceRegister : Register
            {
                ...
                public async Task<TempSourceRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AxisMapConfigRegister : Register
            {
                ...
                public async Task<AxisMapConfigRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AxisMapSignRegister : Register
            {
                ...
                public async Task<AxisMapSignRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelOffsetXRegister : Register
            {
                ...
                public async Task<AccelOffsetXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelOffsetYRegister : Register
            {
                ...
                public async Task<AccelOffsetYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelOffsetZRegister : Register
            {
                ...
                public async Task<AccelOffsetZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerOffsetXRegister : Register
            {
                ...
                public async Task<MagnetometerOffsetXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerOffsetYRegister : Register
            {
                ...
                public async Task<MagnetometerOffsetYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagnetometerOffsetZRegister : Register
            {
                ...
                public async Task<MagnetometerOffsetZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GyroOffsetXRegister : Register
            {
                ...
                public async Task<GyroOffsetXRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GyroOffsetYRegister : Register
            {
                ...
                public async Task<GyroOffsetYRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class GyroOffsetZRegister : Register
            {
                ...
                public async Task<GyroOffsetZRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class AccelRadiusRegister : Register
            {
                ...
                public async Task<AccelRadiusRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class MagRadiusRegister : Register
            {
                ...
                public async Task<MagRadiusRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
