...
namespace Treehopper.Libraries.Sensors
{
    ...
    /// <remarks>
    ///     <para>
    ///         While simple devices (such as temperature sensors) can simply auto-update whenever the relevant properties are
    ///         read from, it is often useful to continuously update these values on a background thread so that the
    ///         <see cref="IPollable" /> device can fire events. This is especially true for GPIO port expanders used as inputs
    ///         in event-driven programming.
    ///     </para>
    ///     <para>
    ///         Since this class implements INotifyPropertyChanged, WPF and XAML applications can bind directly to properties
    ///         of the underlying sensor in this class, and GUI controls will be automatically updated
    ///     </para>
    /// </remarks>
    public class Poller<TPollable> : INotifyPropertyChanged, IDisposable where TPollable : IPollable
    {
        ...
        /// <remarks>
        ///     <para>
        ///         When <paramref name="usePrecisionTimer" /> is set to true, a busy-wait timer will be used. All things
        ///         considered, this provides for relatively precise timing (even given USB latencies, there is often less than 100
        ///         microseconds of jitter), but this will cause dramatic increases in CPU usage. We recommend enabling this only
        ///         in scenarios where you absolutely need low-jitter sampling.
        ///     </para>
        /// </remarks>
