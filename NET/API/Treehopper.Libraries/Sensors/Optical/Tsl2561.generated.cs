    ...
    public partial class Tsl2561
    {
        ...
        protected class Tsl2561Registers : RegisterManager
        {
            ...
            internal class TimingRegister : Register
            {
                ...
                public async Task<TimingRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class InterruptThresholdLowRegister : Register
            {
                ...
                public async Task<InterruptThresholdLowRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class InterruptThresholdHighRegister : Register
            {
                ...
                public async Task<InterruptThresholdHighRegister> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class Data0Register : Register
            {
                ...
                public async Task<Data0Register> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
            ...
            internal class Data1Register : Register
            {
                ...
                public async Task<Data1Register> read()
                {
                    await manager.read(this).ConfigureAwait(false);
                    return this;
                }
