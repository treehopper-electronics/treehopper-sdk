...
{
    /// <summary>
    ///     A motorized fader contains a DC motor, speed controller, and servo functionality to set the fader to a particular
    ///     position and quickly disabling the drive to allow the user to easily move the fader.
    /// </summary>
