namespace Treehopper
{
    ...
    /// <remarks>
    /// <para>
    /// Since both the <see cref="SoftPwm"/> and <see cref="Pwm"/> classes implement this interface, it is useful for applications 
    ...
    /// </para>
    /// <para>
    /// Since <see cref="Pwm"/> and <see cref="SoftPwm"/> have different periods (and different ways of setting the period), period control is not
    /// available in this interface. However, <see cref="Pwm"/> initializes to a period of approximately 780 Hz and <see cref="SoftPwm"/> initializes with
    ...
    /// are desired, your library should use <see cref="Pwm"/> or <see cref="SoftPwm"/> directly.
    /// </para>
    /// 
    /// </remarks>
