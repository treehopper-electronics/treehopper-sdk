...
namespace Treehopper
{
    ...
    /// 
    /// </remarks>
    public class TreehopperBoard : INotifyPropertyChanged, IDisposable, IComparable, IEquatable<TreehopperBoard>, IEqualityComparer<TreehopperBoard>
    {
        // USB stuff
        UsbDevice usb;
        ...
        internal TreehopperBoard(UsbDevice device)
        {
            usb = device;
        ...
        {
            TreehopperBoard board = obj as TreehopperBoard;
            if (board == null)
                return 1;
        ...
        public bool Equals(TreehopperBoard other)
        {
        ...
        /// <returns></returns>
        public bool Equals(TreehopperBoard x, TreehopperBoard y)
        {
            if (x == null || y == null)
                return false;
        ...
        public int GetHashCode(TreehopperBoard board)
        {
            if (board != null)
        ...
        {
            TreehopperBoard y = obj as TreehopperBoard;
            if (y == null)
                return false;
            else
    ...
    /// </summary>
    public class TreehopperBoardEqualityComparer : EqualityComparer<TreehopperBoard>
    {
        /// <summary>
        /// Determines if two treehopper boards are the same
        /// </summary>
        ...
        public override bool Equals(TreehopperBoard x, TreehopperBoard y)
        {
            if (x == null || y == null)
                return false;
            return (x.SerialNumber == y.SerialNumber);
        ...
        public override int GetHashCode(TreehopperBoard obj)
        {
            if (obj != null)
