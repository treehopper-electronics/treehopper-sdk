...
public class Spi {
    ...
    public Spi(TreehopperUsb board) {
        this.board = board;
    }
    ...
    public byte[] SendReceive(byte[] dataToWrite, Pin chipSelect, ChipSelectMode chipSelectMode) {
        return SendReceive(dataToWrite, chipSelect, chipSelectMode, 1, BurstMode.NoBurst, SpiMode.Mode00);
    }

    public byte[] SendReceive(byte[] dataToWrite, Pin chipSelect, ChipSelectMode chipSelectMode, double speedMhz) {
        return SendReceive(dataToWrite, chipSelect, chipSelectMode, speedMhz, BurstMode.NoBurst, SpiMode.Mode00);
    }

    public byte[] SendReceive(byte[] dataToWrite, Pin chipSelect, ChipSelectMode chipSelectMode, double speedMhz, BurstMode burstMode) {
        return SendReceive(dataToWrite, chipSelect, chipSelectMode, speedMhz, burstMode, SpiMode.Mode00);
    }


    public byte[] SendReceive(byte[] dataToWrite, Pin chipSelect, ChipSelectMode chipSelectMode, double speedMhz, BurstMode burstMode, SpiMode spiMode)
    {
        if(!enabled)
        {
