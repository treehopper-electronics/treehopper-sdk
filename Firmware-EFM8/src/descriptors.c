...
SI_LOCATED_VARIABLE_NO_INIT(nameDesc[64], USB_StringDescriptor_TypeDef, SI_SEG_CODE, NAME_ADDR);
SI_LOCATED_VARIABLE_NO_INIT(serDesc[64], USB_StringDescriptor_TypeDef, SI_SEG_CODE, SER_ADDR);
