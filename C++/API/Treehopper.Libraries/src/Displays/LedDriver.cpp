...
namespace Treehopper {
	namespace Libraries {
		namespace Displays {
			...
			LedDriver::LedDriver(int numLeds, bool hasGlobalBrightnessControl, bool hasIndividualBrightnessControl) : hasGlobalBrightnessControl(hasGlobalBrightnessControl), hasIndividualBrightnessControl(hasIndividualBrightnessControl)
			{
