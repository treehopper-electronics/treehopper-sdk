        ...
        namespace Sensors {
            namespace Pressure {
				...
				void Bmp280::update()
				{
					...
					auto var1 = (registers.temperature.value / 16384.0 - registers.t1.value / 1024.0) * registers.t2.value;
					auto var2 = ((registers.temperature.value / 131072.0 - registers.t1.value / 8192.0) * (registers.temperature.value / 131072.0 - registers.t1.value / 8192.0)) * registers.t3.value;
					tFine = (var1 + var2);
