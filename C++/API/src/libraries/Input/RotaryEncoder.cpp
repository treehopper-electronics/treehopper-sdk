...
namespace Treehopper {
    namespace Libraries {
        namespace Input {
            ...
            RotaryEncoder::RotaryEncoder(DigitalIn &channelA, DigitalIn &channelB, int stepsPerTick) : positionChanged(
                    *this), a(channelA), b(channelB), stepsPerTick(stepsPerTick), _position(0), oldPosition(0) {
                a.makeDigitalInput();
                b.makeDigitalInput();
