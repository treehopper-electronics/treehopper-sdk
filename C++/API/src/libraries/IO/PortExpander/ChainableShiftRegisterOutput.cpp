    ...
    namespace Libraries {
        namespace IO {
            namespace PortExpander {
                ...
                ChainableShiftRegisterOutput::ChainableShiftRegisterOutput(ChainableShiftRegisterOutput &upstreamDevice,
                                                                           int numBytes) {
                ...
                void ChainableShiftRegisterOutput::requestWrite() {
                    ...
                    spiDevice->sendReceive(bytes, SpiBurstMode::BurstTx);
                }

                void ChainableShiftRegisterOutput::setupSpi(Spi &spiModule, SpiChipSelectPin *latchPin, double speedMhz,
                                                            SpiMode mode, ChipSelectMode csMode) {
                    ChainableShiftRegisterOutput::spiDevice = new SpiDevice(spiModule, latchPin, csMode, speedMhz,
                                                                            mode);
                }
