...
namespace Treehopper { namespace Libraries { namespace Interface { namespace Adc { 
    class Nau7802Registers
    {
        ...
        public:
            ...
            class AdcRegister
            {
                ...
                long getValue() { return ((RegChp & 0x3) << 0) | ((AdcVcm & 0x3) << 2) | ((RegChps & 0x3) << 4); }
                void setValue(long value)
                {
                    RegChp = (int)((value >> 0) & 0x3);
                    AdcVcm = (int)((value >> 2) & 0x3);
                    RegChps = (int)((value >> 4) & 0x3);
                }
            };
