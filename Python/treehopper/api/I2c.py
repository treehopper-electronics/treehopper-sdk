...
class HardwareI2C(I2C):
    ...
    \subsection addressing Addressing
    ...
    \subsection sendreceive send_receive() Function
    ...
    \subsection pullup Pull-Up Resistors
    ...
    \subsection conflict Address Conflicts
    ...
    \subsection level-convert Logic-Level Conversion
