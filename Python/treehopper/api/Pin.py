...
class Pin(AdcPin, DigitalIn, SpiChipSelectPin, Pwm):
    ...
    You can set or retrieve the digital value of a pin by accessing the \link Pin.digital_value digital_value\endlink property. Note that writing to this property --- even if the pin is an input --- will implicitly change it into an output.
